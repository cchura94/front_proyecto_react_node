...
const Producto = () => {
    ...
    const [modalOpenImagen, setOpenModalImagen] = useState(false)
    ...
    const actualizarImagen = async () => {
        ...
        await productoService.actualizarImagen(idprod.id, formdata)
        resetDataImagen()
        getProductos()
    }
    ...
    return (
        <>
                    ...
                    {productos.map((prod, index) => (
                        <tr key={prod.id}>
                            ...
                            <td className="py-2 px-4 text-sm text-gray-500">
                                ...
                                <button className="py-1 px-2 bg-yellow-500 text-white hover:bg-yellow-600 rounded" onClick={() => openModalImagen(prod)}>
            ...
            {idprod &&
                ...
                <Modal modalOpen={modalOpenImagen} setOpenModal={resetDataImagen}>

                    <img src={`http://127.0.0.1:3000/${idprod.imagen}`} alt="" />
                    <hr />

                    <input type="file" accept="image/*" onChange={handleChangeImage} />
                    <br />
                    <input type="button" className="py-1 px-2 bg-blue-500 text-white hover:bg-blue-600 rounded" onClick={actualizarImagen} value="Subir Imagen" />
