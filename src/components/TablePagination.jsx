...
const TablePagination = ({ columnas, datos, total, page, fetchData, handleEdit, handleDelete, handleShow, handleAddCarrito }) => {
                        ...
                        <tr key={reg.id}>
                            ...
                            <td className="py-2 px-4 text-sm text-gray-500">
                                ...
                                {handleAddCarrito &&
                                    ...
                                    <button className="py-1 px-2 bg-yellow-500 text-white hover:bg-yellow-600 rounded" >
